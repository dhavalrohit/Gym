...
import com.gym.controller.AddMemberDataTest;
 ...
 * @author DELL
 */
public class Machine_AddMemberDownload extends JFrame{
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Machine_AddMemberDownload frame = new Machine_AddMemberDownload();
        ...
        public Machine_AddMemberDownload() {
			...
			public void actionPerformed(ActionEvent arg0) {
				//String sql="Select ID, EmpCode, CardNo, Datetrn, InTime, OutTime, McNo From RawPunchDetail where EmpCode='"+txtSearch.getText()+"' GROUP BY ID, EmpCode, CardNo, Datetrn, InTime, OutTime, McNo";
                                //String sql="Select ID, EmpCode, CardNo, Datetrn, InTime, OutTime, McNo From RawPunchDetail GROUP BY ID, EmpCode, CardNo, Datetrn, InTime, OutTime, McNo HAVING Datetrn='"+txtdate.getText()+"' And EmpCode='"+txtSearch.getText()+"'";
                                 ...
                                 //String sql= "SELECT * FROM RawPunchDetail WHERE EmpCode='"+txtSearch.getText()+"' OR Datetrn='"+txtdate.getText()+"' in (SELECT ID, EmpCode, CardNo, Datetrn, InTime, OutTime, McNo FROM RawPunchDetail GROUP BY ID, EmpCode, CardNo, Datetrn, InTime, OutTime, McNo HAVING COUNT(*) > 1)";
                                 //String sql= "SELECT * FROM RawPunchDetail WHERE EmpCode='"+txtSearch.getText()+"' and Datetrn>='"+txtdate.getText()+"'";
 // String sql="Select EmpCode, CardNo, Name, Address, Email, Father From empmst WHERE  EmpCode='"+txtSearch.getText()+"' and (Datetrn between '"+txtdate.getText()+"' and  '"+txtenddate.getText()+"')";
                            String sql="Select EmpCode, CardNo, Name, Address, Email, Father From empmst WHERE  EmpCode='"+txtSearch.getText()+"'";
...
//String sql="Select ID, EmpCode, CardNo, Datetrn, InTime, OutTime, McNo From RawPunchDetail where (EmpCode='"+txtSearch.getText()+"' AND Datetrn='"+txtdate.getText()+"') OR Datetrn='"+txtdate.getText()+"'";
		...
		btnSearchM.setBounds(870, 100, 100, 30);
		...
		contentPane.add(btn_edate);*/
                 ...
                 JLabel infotxt = new JLabel("Download new user Added from Biometric Software");
		infotxt.setFont(new Font("Tahoma", Font.BOLD, 25));
		infotxt.setBounds(20, 60, 700, 36);
		contentPane.add(infotxt);
		
		JLabel lblMembershipNo = new JLabel("Check Membership no after Download");
		lblMembershipNo.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblMembershipNo.setBounds(750, 80, 300, 14);
		...
		txtSearch.setBounds(760, 100, 100, 30);
		contentPane.add(txtSearch);
		txtSearch.setColumns(10);
                
                
                btn_view_all=new JButton("Added Records");
                btn_view_all.setMnemonic(KeyEvent.VK_V);
                btn_view_all.setToolTipText("Added Records");
		...
		//btn_view.setIcon(new ImageIcon(Add_Member.class.getResource("/images/save.png")));
			...
			public void actionPerformed(ActionEvent ae) {
                ...
                {
                        vrd=new ViewRecrdclasses("Added Records");
                        vrd.View_Added_Record();
		...
		counterLabel.setBounds(420, 110, 200, 100);
		...
		counterLabel.setFont(font1);
               ...
               // counterLabel.setVisible(true); 
                ...
                //7 days views data
                btn_view_sev=new JButton("Download new Member");
                btn_view_sev.setMnemonic(KeyEvent.VK_V);
                btn_view_sev.setToolTipText("Download new Member");
		...
		//btn_view.setIcon(new ImageIcon(Add_Member.class.getResource("/images/save.png")));
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(minute==0 && second==0) {
                    ...
                    AddMemberDataTest add = new AddMemberDataTest();
		...
		btn_view_sev.setBounds(180,140,250,30);
