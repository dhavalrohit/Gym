...
public class Message1 extends JFrame{
	...
	public Message1() {
		setResizable(false);
		setTitle("Fitness Hub || Messaging");
		...
		btnSend.setIcon(new ImageIcon(Message1.class.getResource("/images/send Msz.png")));
		...
		btnCancel.setIcon(new ImageIcon(Message1.class.getResource("/images/cancel.png")));
		...
		btnAdd.setIcon(new ImageIcon(Message1.class.getResource("/images/add Msz.png")));
		...
		panel.add(btnClear);
		btnClear.setIcon(new ImageIcon(Message1.class.getResource("/images/delete.png")));
		...
		btnClear_1.setIcon(new ImageIcon(Message1.class.getResource("/images/clear all.png")));
		...
		panel.add(btnUpdate);
		btnUpdate.setIcon(new ImageIcon(Message1.class.getResource("/images/update.png")));
