...
public class Loading_Progress extends JFrame implements Runnable{
    JProgressBar progressBar;
		...
		public final void initialize() {
			...
			//label.setIcon(new ImageIcon(Loading_Progress.class.getResource("/images/Progressing.jpg")));
                       //label.setIcon(new ImageIcon("../images/Progressing.jpg"));
                       label.setIcon(new ImageIcon(getClass().getResource("/images/progressing.gif")));
