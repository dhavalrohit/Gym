...
public class Table extends JTable{
    ...
    public void fixTable(JScrollPane scrollpane1) {
        scrollpane1.getViewport().setBackground(Color.WHITE);
       scrollpane1.setVerticalScrollBar(new ScrollBarCustom());
        JPanel p = new JPanel();
        p.setBackground(Color.WHITE);
        scrollpane1.setCorner(JScrollPane.UPPER_RIGHT_CORNER, p);
        scrollpane1.setBorder(new EmptyBorder(5, 10, 5, 10));
    
    }
    
    public void fix_secondTable(JScrollPane scrollpane2) {
        scrollpane2.getViewport().setBackground(Color.WHITE);
       scrollpane2.setVerticalScrollBar(new ScrollBarCustom());
        JPanel p2 = new JPanel();
        p2.setBackground(Color.WHITE);
        scrollpane2.setCorner(JScrollPane.UPPER_RIGHT_CORNER, p2);
        scrollpane2.setBorder(new EmptyBorder(5, 10, 5, 10));
    }
}
