...
import com.gym.general.login.PanelCover;
...
public class addmemberFrame extends javax.swing.JFrame{
    ...
    private MemberRegistrationPanel cover;
    private AddMemberLayeredPanel loginAndRegister;
    ...
    private void init() {
        ...
        cover = new MemberRegistrationPanel();
        loginAndRegister = new AddMemberLayeredPanel();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                System.out.println("Add Member Frame");
