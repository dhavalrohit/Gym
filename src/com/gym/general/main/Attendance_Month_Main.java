...
public class Attendance_Month_Main extends javax.swing.JFrame{
    ...
    private attendanceMonthRecord form;
    private static Attendance_Month_Main attendance_obj;
      
    public Attendance_Month_Main() throws SQLException {
        initComponents();
        init();
    }
    ...
    private void init() throws SQLException {
        ...
        menu.addEvent(new EventMenuSelected() {
            ...
            public void menuSelected(int menuIndex, int subMenuIndex) {
                System.out.println("Month Attendance Menu Index : " + menuIndex + " SubMenu Index " + subMenuIndex);
                if (menuIndex == 0) {
                    if (subMenuIndex == 0) {
                        try {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    attendance_obj=new Attendance_Month_Main();
                } catch (SQLException ex) {
